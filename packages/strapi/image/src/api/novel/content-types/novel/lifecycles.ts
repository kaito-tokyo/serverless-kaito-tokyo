export default {
  async afterCreate(event: any) {
    ...
    try {
      ...
      strapi.log.error(
        "Failed to dispatch GitHub Action for novel creation:",
        error,
      );
    }
  },
  ...
  async afterCreateMany(event: any) {
    ...
    try {
      ...
      strapi.log.error(
        "Failed to dispatch GitHub Action for novel creation (many):",
        error,
      );
    }
  },
  ...
  async afterUpdate(event: any) {
    ...
    try {
      ...
      strapi.log.error(
        "Failed to dispatch GitHub Action for novel update:",
        error,
      );
    }
  },
  ...
  async afterUpdateMany(event: any) {
    ...
    try {
      ...
      strapi.log.error(
        "Failed to dispatch GitHub Action for novel update (many):",
        error,
      );
    }
  },
  ...
  async afterDelete(event: any) {
    ...
    try {
      ...
      strapi.log.error(
        "Failed to dispatch GitHub Action for novel deletion:",
        error,
      );
    }
  },
  ...
  async afterDeleteMany(event) {
    ...
    try {
      ...
      strapi.log.error(
        "Failed to dispatch GitHub Action for novel deletion (many):",
        error,
      );
    }
  },
