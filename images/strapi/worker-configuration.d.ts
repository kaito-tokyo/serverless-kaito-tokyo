/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 65b2ab78860aa7854b7affcca1d2fc5b)
...
declare namespace Cloudflare {
	interface Env {
		...
		STRAPI_CONTAINER: DurableObjectNamespace<import("./src/index").StrapiContainer>;
		DB: Hyperdrive;
	}
}
